export const universeNodeData = {
    "col": 5,  // Columns: A, B, C, D, E
    "row": 11,  // Rows: 1-9
    "seats": [
        // Row 1
        ...
        { seat: "10-C", status: 'hide' },
        { seat: "10-D", status: 'Available' },
        { seat: "10-E", status: 'Available' },

        // Row 11
        { seat: "11-A", status: 'Available' },
        { seat: "11-B", status: 'Available' },
        { seat: "11-C", status: 'Available' },
        { seat: "11-D", status: 'Available' },
        { seat: "11-E", status: 'Available' }
    ]
};